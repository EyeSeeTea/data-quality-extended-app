...
export type TrackedEntitiesGetResponse<
    Fields extends D2TrackerTrackedEntityFields = D2TrackerTrackedEntitySchema["fieldPresets"]["$all"]
> = TrackedEntitiesGetResponseBase<Fields>;

export type TrackerEventsResponse<
    Fields extends D2TrackerEventFields = D2TrackerEventSchema["fieldPresets"]["$all"]
